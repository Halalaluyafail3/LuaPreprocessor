...
When the function returns, the visible tokens are the macro expansion. Generally, a macro should only try and view and manipulate tokens in a defined region, such as in a set of brackets rather than work with all visible tokens.
